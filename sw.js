...
const ASSETS = [
  ...
  './icon-180.png',
  './manifest.json',
  // Score Analyser (embedded via iframe)
  './Music App/index.html',
  './Music App/manifest.json',
  './Music App/icons/icon-192.png',
  './Music App/icons/icon-512.png',
  './Music App/icons/apple-touch-icon.png',
